  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1, margin: 0, position: "absolute" }}>
        ...
        <Text style={styles.subTitle}>Pet Care Center</Text>
        ...
        <View>
          ...
          />
            ...
            >
              <Text style={styles.back2SignupText}>I am not a Pet Care Center</Text>
            </TouchableOpacity>
...
export default SignUpPagePetCareCenter;
